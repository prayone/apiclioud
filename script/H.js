...
; ! function (factory) {
    if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
        ...
        factory(window['H'] = {
            ...
            toastLoading: function (duration,ts) {
                var that = this;
                duration = Math.abs(that.isNumber(duration) ? Number(duration) : 30000);
                that.toastCore('<span class="H-display-block H-line-height-normal H-animate-rotate"><i class="H-iconfont H-icon-loading H-font-size-42"></i></span>', ts, duration);
            },
             toastJiazai: function (duration) {
                var that = this;
                duration = Math.abs(that.isNumber(duration) ? Number(duration) : 30000);
            ...
            toastxgmm: function (duration) {
                var that = this;
                duration = Math.abs(that.isNumber(duration) ? Number(duration) : 30000);
                that.toastCore('<span class="H-display-block H-line-height-normal H-animate-rotate"><i class="H-iconfont H-icon-loading H-font-size-42"></i></span>', "修改中...", duration);
            },
            closeToast: function () {
                var that = this;
                if (that.Ds("#H-toast-tip") && that.Ds("#H-toast-tip").length > 0) {
